...
use crate::{
    ...
    UriRef,
    UriRefBuf,
    common::{RiBufImpl, RiImpl, RiRefBufImpl, RiRefImpl, parse, str_eq},
    uri::InvalidUriRef,
};
...
#[grammar(file = "src/iri/grammar.abnf", entry_point = "IRI", cache = "automata/iri.aut.cbor")]
...
impl Iri {
    ...
    #[inline]
    pub fn suffix(&self, prefix: &(impl ?Sized + AsRef<Iri>)) -> Option<(PathBuf, Option<&Query>, Option<&Fragment>)> {
