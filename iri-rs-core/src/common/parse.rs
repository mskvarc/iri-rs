...
mod tests {
    ...
    #[test]
    fn find_user_info() {
        let vectors = [("example.org:12", None), ("user@example.org:12", Some("user"))];
    ...
    #[test]
    fn host() {
        let vectors = [("example.org:12", 11), ("example.org", 11), ("[::]", 4), ("", 0)];
    ...
    #[test]
    fn path() {
        let vectors = [("foo/bar?query", 7), ("foo/bar#fragment", 7), ("foo/bar", 7)];
    ...
    #[test]
    fn query() {
        let vectors = [("", (false, 0)), ("?query", (true, 6)), ("?query#fragment", (true, 6))];
    ...
    #[test]
    fn find_query() {
        let vectors = [("path?query", Ok(5..10)), ("path?query#fragment", Ok(5..10)), ("path#fragment", Err(4))];
    ...
    #[test]
    fn find_fragment() {
        let vectors = [("path?query", Err(10)), ("path?query#fragment", Ok(11..19)), ("path#fragment", Ok(5..13))];
